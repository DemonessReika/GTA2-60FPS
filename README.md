...
## Installation
1. Drop `ddraw.dll` next to `gta2.exe` (GTA 2 installation folder).
2. Copy your **real** 32-bit `ddraw.dll` from `C:\Windows\SysWOW64\ddraw.dll` into the same folder and rename it to `real_ddraw.dll`.
